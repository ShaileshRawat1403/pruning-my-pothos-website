  ...
  if (slug === "natural-language-programming-stack") {
    return (
      <div className="flex flex-col gap-8 w-full">
        ...
        {/* Content Card */}
        <div className="card-glass p-6 sm:p-8 flex flex-col gap-6 bg-black/10">
          <h2 className="font-heading text-xl font-bold text-[var(--text-primary)]">The Seven Layers of Alignment</h2>
          ...
          {/* Table list */}
          <div className="border border-[var(--card-border)] rounded-lg overflow-hidden font-mono text-xs mt-4">
            <div className="bg-white/[0.03] p-3 border-b border-[var(--card-border)] flex justify-between font-bold text-accent-cyan">
              <span>LAYER</span>
              <span>PURPOSE / BOUNDARY</span>
            </div>
            
            <div className="p-3 border-b border-white/[0.03] flex justify-between">
              <strong className="text-[var(--text-primary)]">07. Governance / HITL</strong>
              <span className="text-accent-pink">Human approvals and check promotion gates</span>
            </div>
            <div className="p-3 border-b border-white/[0.03] flex justify-between">
              <strong className="text-[var(--text-primary)]">06. Execution Ledger</strong>
              <span className="text-accent-orange">Immutable local operation logs (ledger.jsonl)</span>
            </div>
            <div className="p-3 border-b border-white/[0.03] flex justify-between">
              <strong className="text-[var(--text-primary)]">05. Guided Loops</strong>
              <span className="text-accent-purple">Self-correction and validation feedback steps</span>
            </div>
            <div className="p-3 border-b border-white/[0.03] flex justify-between">
              <strong className="text-[var(--text-primary)]">04. Workflow Engine</strong>
              <span className="text-[var(--text-primary)]">Job-pack contracts (Input ➔ Normalize ➔ Map)</span>
            </div>
            <div className="p-3 border-b border-white/[0.03] flex justify-between">
              <strong className="text-[var(--text-primary)]">03. Evaluation Harness</strong>
              <span className="text-text-secondary">Rubric scoring and local assertion testing</span>
            </div>
            <div className="p-3 border-b border-white/[0.03] flex justify-between">
              <strong className="text-[var(--text-primary)]">02. Context Architecture</strong>
              <span className="text-text-secondary">Workspace context-packing (XML tree structure)</span>
            </div>
            <div className="p-3 flex justify-between">
              <strong className="text-[var(--text-primary)]">01. Prompt Interface</strong>
              <span className="text-text-muted">Structured schemas, typings, and JSON contracts</span>
            </div>
          </div>

          <h3 className="font-heading text-base font-bold text-[var(--text-primary)] mt-6">Layer Details</h3>
          
          <div className="flex flex-col gap-4 text-sm text-text-secondary">
            <div>
              <h4 className="font-heading font-semibold text-accent-cyan mb-1">01. Prompt & Context Layers</h4>
            ...
            <div>
              <h4 className="font-heading font-semibold text-accent-purple mb-1">02. Harness & Evaluation Layers</h4>
              <p className="leading-relaxed">
            ...
            <div>
              <h4 className="font-heading font-semibold text-accent-orange mb-1">03. Guided Loop & Ledger Layers</h4>
              <p className="leading-relaxed">
            ...
            <div>
              <h4 className="font-heading font-semibold text-accent-pink mb-1">04. Governance / Human-in-the-Loop</h4>
              <p className="leading-relaxed">
  ...
  if (slug === "public-private-boundary") {
    return (
      <div className="flex flex-col gap-8 w-full">
        ...
        {/* Content Card */}
        <div className="card-glass p-6 sm:p-8 flex flex-col gap-6 bg-black/10">
          <h2 className="font-heading text-xl font-bold text-[var(--text-primary)]">Ecosystem Partitioning</h2>
          <p className="text-text-secondary text-sm leading-relaxed">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 my-4">
            <div className="border border-[var(--card-border)] p-5 rounded-lg bg-accent-cyan/5">
              <h3 className="text-accent-cyan font-heading font-bold text-sm mb-3">🔓 Public Lab</h3>
            ...
            <div className="border border-[var(--card-border)] p-5 rounded-lg bg-accent-purple/5">
              <h3 className="text-accent-purple font-heading font-bold text-sm mb-3">🔒 Private Runtime</h3>
              <ul className="text-xs text-text-secondary flex flex-col gap-2 list-disc pl-4">
                <li>Production loop runners (Governance engine)</li>
                <li>Proprietary evaluation job-packs (Tessera adapters)</li>
                <li>Custom developer cockpit integrations</li>
          ...
          <h3 className="font-heading text-base font-bold text-[var(--text-primary)] mt-4">Why This Split Exists</h3>
          <div className="flex flex-col gap-4 text-sm text-text-secondary">
            <p>
            ...
            <p>
              <strong>3. Reusable Standards:</strong> By isolating execution, we can publish public tools that act as clean, stateless adapters &mdash; enabling developers to model schemas and compile diagrams without needing complex backend deployments.
            </p>
          </div>
        </div>
      </div>
  ...
  if (slug === "tool-status") {
    return (
      <div className="flex flex-col gap-8 w-full">
        ...
        {/* Content Card */}
        <div className="card-glass p-6 sm:p-8 flex flex-col gap-6 bg-black/10">
          <h2 className="font-heading text-xl font-bold text-[var(--text-primary)]">System Status Models</h2>
          <p className="text-text-secondary text-sm leading-relaxed">
          ...
          <div className="flex flex-col gap-6 mt-4">
            <div className="border border-[var(--card-border)] border-l-4 border-l-accent-cyan p-5 rounded-r-lg bg-accent-cyan/5">
              <div className="flex items-center gap-3 mb-2">
                <span className="px-2 py-0.5 rounded bg-accent-cyan/20 text-accent-cyan text-[10px] font-mono font-bold uppercase">Client-Side Live</span>
              </div>
            ...
            <div className="border border-[var(--card-border)] border-l-4 border-l-accent-purple p-5 rounded-r-lg bg-accent-purple/5">
              <div className="flex items-center gap-3 mb-2">
                <span className="px-2 py-0.5 rounded bg-accent-purple/20 text-accent-purple text-[10px] font-mono font-bold uppercase">Browser Prototype</span>
              </div>
              <p className="text-sm text-text-secondary leading-relaxed">
            ...
            <div className="border border-[var(--card-border)] border-l-4 border-l-text-muted p-5 rounded-r-lg bg-white/[0.01]">
              <div className="flex items-center gap-3 mb-2">
                <span className="px-2 py-0.5 rounded bg-white/10 text-text-muted text-[10px] font-mono font-bold uppercase">Planned Concept</span>
              </div>
              <p className="text-sm text-text-secondary leading-relaxed">
            ...
            <div className="border border-[var(--card-border)] border-l-4 border-l-accent-orange p-5 rounded-r-lg bg-accent-orange/5">
              <div className="flex items-center gap-3 mb-2">
                <span className="px-2 py-0.5 rounded bg-accent-orange/20 text-accent-orange text-[10px] font-mono font-bold uppercase">Restricted Private Runtime</span>
              </div>
              <p className="text-sm text-text-secondary leading-relaxed">
