...
export const metadata = constructMetadata({
  title: "Technical Marketing Portfolio | Systems Bench",
  ...
  return (
    <div className="relative w-full flex flex-col gap-12 max-w-[1100px] mx-auto py-8">
      ...
      <section className="flex flex-col gap-2">
        <span className="inline-flex self-start px-2.5 py-0.5 rounded-full border border-accent-orange/25 bg-accent-orange/10 text-[10px] font-mono font-bold tracking-wider text-accent-orange uppercase">
          PORTFOLIO
        </span>
      ...
      <section className="flex flex-col gap-6">
        <h2 className="font-heading text-xl font-bold text-[var(--text-primary)] border-b border-[var(--card-border)] pb-2">
          Focus Areas
        </h2>
            ...
            <div key={idx} className="card-glass p-6 flex flex-col gap-4 justify-between bg-black/10">
              <div className="flex flex-col gap-2">
                <div className="flex justify-between items-center text-[10px] font-mono text-text-muted">
                  ...
                  <span className="px-2 py-0.5 rounded bg-white/5 border border-white/10 text-[9px] font-semibold text-text-secondary">
                    {proj.status}
                  </span>
                </div>
