...
For related architecture views, see [From Agent Intent to Governed Execution](/systems/from-agent-intent-to-governed-execution/) and [Decision-Making Under Uncertainty in AI Runtimes](/systems/decision-making-under-uncertainty-in-ai-runtimes/).
