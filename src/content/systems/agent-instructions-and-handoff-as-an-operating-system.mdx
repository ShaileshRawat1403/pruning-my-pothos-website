...
For related architecture views, see [Observability First: How AI Systems Learn After Launch](/systems/observability-first-ai-systems/), [Tech Stack for NLPg-Driven AI-Assisted SDLC](/systems/tech-stack-for-nlpg-driven-ai-assisted-sdlc/), and [Dual NLP for AI-assisted SDLC](/dual-nlp-framework/). The instruction contract itself is Inform from the [I-7 Cognitive Loop](/systems/i-7-cognitive-loop/): choosing what context an agent may use, made durable across sessions instead of restated every time.
