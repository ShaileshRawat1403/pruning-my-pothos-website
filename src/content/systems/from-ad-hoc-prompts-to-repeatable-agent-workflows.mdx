...
heroImage: '/covers/systems/from-ad-hoc-prompts-to-repeatable-agent-workflows.svg'
heroImageAlt: 'Workflow improvement journey'
tags:
  - agents
  - workflow
  - reliability
