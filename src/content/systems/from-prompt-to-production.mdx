...
heroImageAlt: 'Production checklist steps'
tags:
  - checklist
  - deployment
  - production
...
faq:
  - question: What are the 7 steps from prompt to production?
    answer: "The 7 steps are: (1) Define intent and success criteria, (2) Assess risks and failure modes, (3) Design the interface boundary, (4) Validate output quality, (5) Monitor runtime behavior, (6) Implement human fallback, and (7) Document and version the workflow."
  - question: Why is a prompt in production considered a contract?
    answer: "A prompt in production defines what the system should do, under what conditions, and what counts as success. Unlike playground testing, production prompts cannot be easily changed mid-execution. This contract must be explicit, versioned, and tested before deployment."
  - question: What makes guardrails essential, not optional?
    answer: "Guardrails prevent unintended actions, contain costs, protect against prompt injection, and provide audit trails. Without guardrails, AI systems can exceed their intended scope, produce harmful outputs, or consume resources unpredictably."
---
...
<nav class="toc" aria-label="On-page">
  ...
  <div class="toc-groups">
    <details open>
      ...
      <ol>
        <li><a href="#define-intent-the-contract">Define Intent (The Contract)</a></li>
        <li><a href="#identify-risks-the-red-team">Identify Risks (The Red Team)</a></li>
      </ol>
    </details>
    <details>
      <summary>Act II: The modern paradigm</summary>
      <ol>
        <li><a href="#set-inputsoutputs-the-interface">Set Inputs/Outputs (The Interface)</a></li>
        <li><a href="#validate-the-eval">Validate (The Eval)</a></li>
      </ol>
    </details>
    <details>
      <summary>Act III: Principles in practice</summary>
      <ol>
        <li><a href="#monitor-drift-the-pulse">Monitor Drift (The Pulse)</a></li>
        <li><a href="#human-fallback-the-safety-net">Human Fallback (The Safety Net)</a></li>
...
<figure class="diagram">
  <iframe src="/scenes/human-fallback-flow.html" title="Human Fallback Flow" loading="lazy" scrolling="no" style="pointer-events: none;"></iframe>
