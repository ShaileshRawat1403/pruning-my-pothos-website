...
<nav class="toc" aria-label="On-page">
  ...
  <ol>
    ...
    <li>
      <a href="#prompts-as-contracts">Prompts as Contracts</a>
    </li>
    <li>
      <a href="#what-this-changes-in-practice">What This Changes in Practice</a>
    </li>
    <li>
      <a href="#conclusion-the-system-is-the-message">
