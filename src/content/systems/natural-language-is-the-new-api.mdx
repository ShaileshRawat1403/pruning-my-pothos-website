...
category: "Concepts"
heroImage: '/covers/systems/natural-language-is-the-new-api.svg'
heroImageAlt: 'Natural language interface diagram'
tags:
  - systems
  - api
  - natural-language
  ...
  - llm
proofPoints:
  - Includes 3 architectural diagrams showing interface evolution
  - Core conceptual reference for natural language interfaces
faq:
  - question: Why is natural language now considered an API?
    answer: "Natural language has become an interface for triggering machine behavior, not just a medium for conversation. When prompts define intent, constraints, and success criteria, they function as API contracts that software can invoke and depend on."
  - question: What makes a good natural language interface contract?
    answer: "A good NL interface contract specifies: the action to perform, the input format, the output format, the constraints to respect, and the error behavior. This mirrors traditional API design but uses natural language as the invocation mechanism."
  - question: How do natural language interfaces differ from traditional APIs?
    answer: "Traditional APIs accept structured, typed inputs and return structured outputs. NL interfaces accept free-form language and return free-form language. The flexibility of NL input makes contracts harder to enforce and requires explicit specification of intent."
---
...
- [Intent Architecture as a Language Contract](/systems/intent-architecture-as-a-language-contract/)
