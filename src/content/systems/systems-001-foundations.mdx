...
category: 'Concepts'
heroImage: '/covers/systems/systems-001-foundations.svg'
heroImageAlt: 'Interconnected nodes representing system components and feedback loops'
tags:
  - systems
  - foundations
  - feedback
...
difficulty: 'beginner'
proofPoints:
  - 618 lines of canonical systems terminology and taxonomy
  - Includes glossary anchors for 12 key terms
  - Used as reference by SEO/AEO/GEO framework docs
faq:
  - question: What is a system in the context of AI and technology?
    answer: "A system is a set of interconnected parts that forms a unified whole, where boundaries, interfaces, and feedback loops determine behavior more than any single component."
  - question: What makes systems fail?
    answer: "Systems fail predictably through three mechanisms: drift (gradual deviation from intended state), metric capture (optimizing for the wrong measure), and variety mismatch (the system cannot handle the diversity of inputs it receives)."
  - question: What is a socio-technical system?
    answer: "A socio-technical system is one where human intent and machine execution are interdependent. Modern AI systems are inherently socio-technical because they require both human governance and automated execution to function reliably."
---
...
Shannon formalized information as a measurable signal, and Wiener formalized feedback and control, making adaptation explicit rather than accidental ([Shannon, 1948](https://people.math.harvard.edu/~ctm/home/text/others/shannon/entropy/entropy.pdf); [Wiener, 1948](https://en.wikipedia.org/wiki/Cybernetics:_Or_Control_and_Communication_in_the_Animal_and_the_Machine)). These are milestones in how systems learn.

<figure class="diagram">
  <iframe src="/scenes/ipo-feedback.html" title="Input, process, output flow with feedback" loading="lazy" scrolling="no" style="pointer-events: none;"></iframe>
...
Sources: [CDC Heart Disease](https://www.cdc.gov/heart-disease/about/index.html), [ITU Facts and Figures 2023](https://www.itu.int/itu-d/reports/statistics/facts-figures-2023/).

## Act II: The modern paradigm

### The socio-technical merge

The old divide between "people" and "software" has evolved into a <span class="highlight">unified socio-technical system</span>: human intent, organizational culture, and machine execution are interdependent ([Trist & Bamforth, 1951](https://en.wikipedia.org/wiki/Socio-technical_systems)).
...
<figure class="diagram">
  <iframe src="/scenes/sociotechnical-layers.html" title="Socio-technical layers" loading="lazy" scrolling="no" style="pointer-events: none;"></iframe>
...
This layer covers how the system perceives and acts. Modern systems add decision-centric behavior: simulate outcomes, score tradeoffs, and recommend actions ([Process Mining community resources](https://www.tf-pm.org/resources)).
...
These are operational constraints. High-risk systems now require explicit human oversight ([EU AI Act, 2024](https://ec.europa.eu/commission/presscorner/detail/en/ip_24_3031); [NIST AI RMF 1.0](https://www.nist.gov/itl/ai-risk-management-framework)).
...
<figure class="diagram">
  <iframe src="/scenes/governance-as-code.html" title="Governance as code pipeline" loading="lazy" scrolling="no" style="pointer-events: none;"></iframe>
...
<figure class="diagram">
  <iframe src="/scenes/digital-twin-loop.html" title="Digital twin loop" loading="lazy" scrolling="no" style="pointer-events: none;"></iframe>
...
For related systems context, see [From Prompt to Production](/systems/from-prompt-to-production/) and [Natural Language Is the New API](/systems/natural-language-is-the-new-api/). For an applied bridge into current AI execution, see [The Intelligence Assembly Model](/systems/the-intelligence-assembly-model/) and the [Engineering Agentic Systems deck](/shelf/shared-resources/engineering-agentic-systems-deck/).
...
<div class="references">
  <ol class="references-list">
    ...
    <li>
      ...
      <a class="ref-link" href="https://ec.europa.eu/commission/presscorner/detail/en/ip_24_3031"><span class="sr-only">Open reference link</span><svg class="ref-link-icon" viewBox="0 0 24 24" aria-hidden="true" focusable="false"><path d="M14 3h7v7" stroke="currentColor" stroke-width="1.6" fill="none" stroke-linecap="round" stroke-linejoin="round" /><path d="M10 14L21 3" stroke="currentColor" stroke-width="1.6" fill="none" stroke-linecap="round" stroke-linejoin="round" /><path d="M21 14v6a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1h6" stroke="currentColor" stroke-width="1.6" fill="none" stroke-linecap="round" stroke-linejoin="round" /></svg></a>
    </li>
    <li>
    ...
    <li>
      ...
      <a class="ref-link" href="https://www.cdc.gov/heart-disease/about/index.html"><span class="sr-only">Open reference link</span><svg class="ref-link-icon" viewBox="0 0 24 24" aria-hidden="true" focusable="false"><path d="M14 3h7v7" stroke="currentColor" stroke-width="1.6" fill="none" stroke-linecap="round" stroke-linejoin="round" /><path d="M10 14L21 3" stroke="currentColor" stroke-width="1.6" fill="none" stroke-linecap="round" stroke-linejoin="round" /><path d="M21 14v6a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1h6" stroke="currentColor" stroke-width="1.6" fill="none" stroke-linecap="round" stroke-linejoin="round" /></svg></a>
    </li>
    <li>
