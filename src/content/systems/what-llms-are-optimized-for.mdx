...
For related systems context, see [Systems 001: Foundations](/systems/systems-001-foundations/) and [From Prompt to Production](/systems/from-prompt-to-production/). For a complementary mental model, see [Probabilities, Not Truth](/systems/probabilities-not-truth/).
